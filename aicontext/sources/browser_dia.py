...
class BrowserDiaSource(DataSource):
    ...
    def ingest_activity(self, source_path: str, source_config: dict) -> list[ActivityRecord]:
        ...
        for row in visit_rows:
            ...
            records.append(ActivityRecord(
                timestamp=ts, source="dia", service="dia", action="visited",
        ...
        for row in download_rows:
            ...
            records.append(ActivityRecord(
                timestamp=ts, source="dia", service="dia", action="downloaded",
    ...
    def get_reference_doc(self) -> str:
        return """# Dia Browser Reference

Local Dia browser history (visits and downloads). Dia is Chromium-based.

## Services
| Service | Description |
|---------|-------------|
| dia | Local Dia browser history |
...
FROM activity WHERE source='dia' AND action='visited'
